      ...
      <nav className="bg-[#001618]/70 backdrop-blur-md rounded-full border border-[#4ECDC4]/20 shadow-[0_0_15px_rgba(78,205,196,0.1)]">
        <div className="px-6 mx-auto">
          <div className="flex items-center justify-between h-12">
            ...
            {/* Mobile Menu Button */}
            <button className="md:hidden text-white hover:text-[#4ECDC4] transition-colors p-2">
              <svg
                className="h-5 w-5"
                fill="none"
                strokeLinecap="round"
        ...
        <div className="hidden">
          <div className="px-4 py-3 space-y-2">
            <Link
              href="/"
              className="block px-3 py-2 text-white hover:text-[#4ECDC4] transition-colors text-sm"
            >
              Home
            </Link>
            <Link
